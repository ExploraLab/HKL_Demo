...
def runChatHornAnalysis(input_file, output_file, file_type):
    # Endpoint URL
        ...
        try:
            ...
            if status == "succeeded":
                ...
                for invoice in enumerate(data['analyzeResult']['documentResults']):
                    ...
                    invoiceTotal = invoice[1]['fields']['InvoiceTotal']['text']
                    poNum = invoice[1]['fields']['PurchaseOrder']['valueString']
